...
class AgingEvolutionNAS:
    ...
    def run_screening_and_training(self):
        ...
        for i, ind in enumerate(top_n1):
            ...
            acc, _ = evaluator.evaluate_individual(ind, epochs=config.SHORT_TRAIN_EPOCHS, model_type='short')
        ...
        for i, ind in enumerate(top_n2):
            ...
            acc, result = evaluator.evaluate_individual(ind, epochs=config.FULL_TRAIN_EPOCHS, model_type='full')
