...
# 在这里修改你的模型编码列表
# ==========================================
TARGET_ENCODING = [5, 2, 2, 3, 2, 4, 128, 8, 0, 1, 0, 0, 10, 0, 3, 2, 128, 16, 0, 2, 1, 0, 10, 0, 3, 1, 256, 64, 1, 1, 0, 0, 10, 0, 3, 2, 512, 32, 0, 2, 1, 0, 0, 0, 3, 2, 128, 8, 0, 1, 1, 0, 0, 0, 5, 2, 128, 8, 1, 1, 1, 0, 0, 0, 5, 2, 128, 8, 1, 1, 1, 0, 0, 1, 5, 1, 256, 16, 0, 2, 1, 0, 10, 0, 5, 1, 128, 16, 0, 2, 0, 0, 10, 0, 3, 2, 128, 32, 0, 2, 0, 0, 10, 0, 3, 1, 128, 64, 0, 1, 0, 0, 10, 0, 3, 2, 128, 32, 0, 1, 0, 0, 0, 0, 3, 2, 256, 32, 1, 2, 0, 0, 0, 0, 5, 2]
# ==========================================
