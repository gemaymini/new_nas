# -*- coding: utf-8 -*-
"""
Logging utilities for search, evaluation, and training.
"""
import os
import logging
import sys
...
class OperationLogger:
    """Append crossover/mutation operations to a JSONL file."""
...
class Logger:
    ...
    def log_generation(self, gen, best_fitness, avg_fitness, pop_size):
        self.info(
            f"Gen {gen}: Best Fitness={best_fitness:.6f}, Avg Fitness={avg_fitness:.6f}, Pop Size={pop_size}"
        )
